...
const Imgside = (props) => {
    ...
    const {locality,country,country_des,state,state_des,county,county_des,lang,currency,currency_code,incomeLevel,dialCode,isoName} = props.location;
