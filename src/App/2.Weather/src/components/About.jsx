                ...
                <div className="flex flex-col lg:flex-row">
                    <div className='h-auto lg:w-1/2' layout="responsive">
                        <div className='w-full flex justify-center'>
                            <img src={require('../../css/images/me.jpg')} alt='my photo' className="h-96 sm:h-auto w-full"/>
                        </div>
                    </div>
                    <div className='flex px-6 sm:px-12 lg:w-1/2 bg-transparent flex-col'>
                        ...
                        <div className='relative flex justify-center my-4'>
                            ...
                            <a href='https://github.com/Moinak-Majumdar' target='_blank' className='mx-2'>
                                <Tooltip title="github" placement='bottom' className='z-10'>
                                    <GitHubIcon fontSize='large'/>
                                </Tooltip>
                            </a>
                            <a href='https://www.linkedin.com/in/moinak-majumdar-b7a85b238/' target='_blank' className='mx-2' style={{color: '#0077b5'}}>
