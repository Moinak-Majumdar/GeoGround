  ...
  return (
    <>
      <section className="w-full">
        ...
        <h1 className="txt3 font-extrabold text-2xl capitalize text-pink-700 text-center animate-pulse">{props.weather.des}</h1>
        {/* temparature */}
        <div className="mt-2 flex justify-between px-4">
            <div>
              <h1 className="txt2 font-extrabold capitalize text-cyan-700">Avg:</h1>
              <h1 className="txt2 text-3xl font-extrabold text-violet-800">{props.weather.temp}&deg;c</h1>
            </div>
            <div>
              <h1 className="txt2 font-extrabold capitalize text-cyan-700">Feels Like:</h1>
              <h1 className="txt2 text-3xl font-extrabold text-pink-500">{props.weather.feels_like}&deg;c</h1>
            </div>
        </div>
        <div className="mt-4 flex items-center justify-between">
            <div>
                ...
                <div className='inline-flex justify-center items-center txt2'>
                    ...
                    <h2 className="text-indigo-800 font-semibold">{"Min: "+props.weather.temp_min}&deg;c<br/>{"Max: "+props.weather.temp_max}&deg;c</h2>
                </div>
                {/* pressure */}
                <div className='inline-flex justify-center items-center txt2'>
                    ...
                    <h2 className="text-indigo-800 font-semibold">{`Pressure: ${props.weather.pressure}hPa`}</h2>
                </div>
                {/* clouds */}
                <div className='inline-flex justify-center items-center txt2'>
                    <p className='text-3xl h-full flex justify-center items-center my-4 mx-2'>
                    ...
                    <div className="text-indigo-800 font-semibold">
                        <h1>{`Cloudiness: ${props.weather.clouds}%`}</h1>
                        <h1>{`Visibility ${props.weather.visibility}KM`}</h1>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div className='inline-flex justify-center items-center txt2'>
                    ...
                    <h2 className="text-indigo-800 font-semibold">{`humidity: ${props.weather.humidity}%  `}</h2>
                </div>
                {/* wind */}
                <div className='inline-flex justify-center items-center txt2'>
                    <p className='text-3xl h-full flex justify-center items-center my-4 mx-2'>
                    ...
                    <div className="text-indigo-800 font-semibold">
                        <h1>{`Wind speed: ${props.weather.speed} m/s`}</h1>
                        <h1>{`At: ${props.weather.deg}`}&deg;N</h1>
                    </div>
                </div>
        ...
        <div className="mt-4 flex flex-col">
          <h1 className="text-xl">
            ...
            <span className="txt1">{props.weather.lat}&deg;</span>
          </h1>
          <h1 className="text-xl">
            <span className="font-extrabold txt2 mr-2 text-blue-900">
              Longitude:
            </span>
            <span className="txt1">{props.weather.lon}&deg;</span>
          </h1>
        </div>
      </section>
    </>
